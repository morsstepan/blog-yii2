            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="i_con">
                    <ul class="nav navbar-nav text-uppercase">
                        ...
                        <?php else: ?>
                            <?= Html::beginForm(['/site/about'], 'post')
                            . Html::submitButton(
...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2018 <a href="#">Simple blog using Yii2, </a> Built with <i
                                class="fa fa-heart"></i> by <a href="http://www.github.com/morsstepan">Stepan Morozov</a>
                    </div>
                </div>
            </div>
        </div>
